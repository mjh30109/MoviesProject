...
<body>
	<div class="container">
		<div class="input-form">
			...
			<form class="validation-form" novalidate action="u_findId_save"
				method="get" id="check">
				<div class="form-group">
					<label for="u_id">이메일</label> <input type="text"
				...
				<div class="form-group">
					<span><a href="#" id="forgotPw"> 비밀번호를 잊어버리셨습니까? </a></span>
				</div>
	...
	<script>
		document.getElementById("forgotPw").addEventListener("click",
				function(event) {
					...
					var flag = confirm('비밀번호를 찾으실거면 예를 눌러주세요. ')
					//alert(flag)
					if (flag) {
